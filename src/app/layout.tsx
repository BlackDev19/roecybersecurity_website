...
import AffirmScript from '@/components/AffirmScript'
            ...
            <footer className="bg-gray-800 py-10 mt-16 text-sm text-slate-300">
              <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-6">
                ...
                <div className="text-center md:text-left">
                  <p>
                    © 2025 RoeCybersecurity. Tous droits réservés. Développé par{' '}
                    <span className="text-white font-semibold">BLACK-DEV Software</span>
                  </p>
                </div>
